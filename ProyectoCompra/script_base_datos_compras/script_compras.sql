...
(
	...
	Id_Direccion1 INT,
	Id_Direccion2 INT,
	CONSTRAINT constraint_direccion1_fk FOREIGN KEY (Id_Direccion1) REFERENCES Direccion (Id_Direccion),
	CONSTRAINT constraint_direccion2_fk FOREIGN KEY (Id_Direccion2) REFERENCES Direccion (Id_Direccion)
)
