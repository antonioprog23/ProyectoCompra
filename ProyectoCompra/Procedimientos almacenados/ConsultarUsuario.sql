...
BEGIN
	IF (@Id_Usuario = 0)
		BEGIN
			SELECT u.id_usuario,c.id_cliente,u.usuario_name,u.contrasenia,du.fecha_alta,du.fecha_ultima_modificacion,c.nombre,c.apellido,c.edad,c.fecha_nacimiento,c.sexo,c.direccion,u.correo_electronico FROM usuario u
